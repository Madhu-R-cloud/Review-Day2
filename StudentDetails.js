...
// - compute test score for 3 subjects
// - compute total marks 
// - compute percentage
// - allocate grade (100-90 = A, 75-90 = B,  = C, 20< = D)
...
const StudentData = [
    ...
    // const test_score = [{sub: "maths", marks: 70}];
    ...
    function TestScore(){
        // console.log(StudentData[0].test_score)
        ...
        for(let student of StudentData){
            ...
            let Grade =  percentage>=90 ?  'A' :  percentage>=70 && percentage<=90 ?  'B' 
            : percentage>=20 && percentage<=69
             ?  'C' :  'D'
